...
const options = {
    ...
    onClose (selectedDates) {
        if (selectedDates[0] < new Date()) (0, _notiflixDefault.default).Notify.failure("Please choose a date in the future");
        else {
...
(0, _flatpickrDefault.default)(elements.dateInput, options);
let intervalId = 0;
...
function createTimer() {
    ...
    elements.hours.textContent = hoursPicker < 10 ? "0" + hoursPicker : hoursPicker;
    elements.minutes.textContent = minutesPicker < 10 ? "0" + minutesPicker : minutesPicker;
    elements.seconds.textContent = secondsPicker < 10 ? "0" + secondsPicker : secondsPicker;
    if (minutesPicker === 0 && secondsPicker === 0) clearTimer();
}
function clearTimer() {
